...
const carouselData = [
    {
        id: 1,
        image: '../../assets/OfferSliderImages/img1.png'
    },
    {
        id: 2,
        image: '../../assets/OfferSliderImages/img2.png'
    },
    {
        id: 3,
        image: '../../assets/OfferSliderImages/img3.png'
    }
]
    ...
    return (
        <View>
            <View style={styles.offerSlider}>
                <Swiper autoplay={true} autoplayTimeout={5} showsButtons={true} dotColor={colors.text2}
